...
import korekcija from "@/assets/image/second/poliranje-rupes.jpg";

const KorekcijaAbout = () => {
  return (
    <section className="w-full px-4 lg:px-28 pt-12 md:pt-20 bg-[#000000f2]">
      <div className="w-full h-full flex flex-col md:flex-row py-30 items-center justify-between">
        <div data-scroll data-scroll-speed="0.01" className="w-5/6 md:w-2/5">
          <Image
            className="w-full lg:w-[70%] mx-auto"
            src={korekcija}
            alt="auto-korekcija-laka"
          />
        </div>
        <motion.div
          initial={{
